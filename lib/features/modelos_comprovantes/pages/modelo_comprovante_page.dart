...
class ModeloComprovantePage {
  ...
  static final TextEditingController _formatoControler =
                ...
                child: SizedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          child: const Text(
                              "• {hoje} = data no formato yyyy-mm-dd"),
                          onTap: () {
                            String formato = _formatoControler.text.trim();
                            if (!formato.endsWith('-')) {
                              formato = '${formato.trim()} -';
                            }
                            formato += ' {hoje}';
                            _formatoControler.text = formato;
                          },
                        ),
  ...
  static excluirAposConfirmacao(
      BuildContext context, ModeloComprovante modelo) {
    _modeloComprovanteRepository = context.read<ModeloComprovanteRepository>();
